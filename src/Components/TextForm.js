...
<button type="button" className="btn btn-primary" onClick={handleUpClick}>Convert To Upercase</button>
...
<button type="button" className="btn btn-primary mx-1" onClick={handleToClear}>Clear Text</button>
